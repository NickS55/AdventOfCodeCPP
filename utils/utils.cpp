...
std::vector<std::string> split(std::string source, std::string delim,
                               Blanks allow_blanks, Trim trim_subs) {
...
std::vector<std::string> read_lines(std::istream &is, Blanks allow_blanks,
                                    Trim trim_lines) {
...
std::vector<std::string> read_lines(std::string filename, Blanks allow_blanks,
                                    Trim trim_lines) {
